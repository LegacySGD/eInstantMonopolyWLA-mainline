...
public class MonopolyWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MonopolyWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MonopolyWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MonopolyWLAIW/InitOutcome.xml").getDocumentElement();
